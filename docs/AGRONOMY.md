...
- `baseline_litres_no_rain` is the same-day result with zero forecast rain. `rain_adjustment_litres` is its difference from the recommendation; it is not a claim about total water saved.
